export const products = [
...

  {
    ...
    images: ['/photos/products/battery-container.webp'],
    featured: true,
  },
  {
    id: 'battery-lid',
    ...
    images: ['/photos/products/battery-lid.webp'],
    featured: true,
  },
...

  {
    ...
    images: [
      '/photos/products/bottom-bar-15-spine-slurry.webp',
      '/photos/products/bottom-bar-15-spine-8.1x2.5.webp',
      '/photos/products/bottom-bar-18-spine-3mm.webp',
      '/photos/products/bottom-bar-18-spine-slurry-3.5.webp',
      '/photos/products/bottom-bar-18-spine-8.1x2.5.webp',
      '/photos/products/bottom-bar-18-spine-8.1x2.7.webp',
      '/photos/products/bottom-bar-18-spine-8.5x2.7.webp',
      '/photos/products/bottom-bar-19-spine-slurry.webp',
      '/photos/products/bottom-bar-20-spine-6.3x1.8.webp',
      '/photos/products/bottom-bar-20-spine-6.3x1.9.webp',
      '/photos/products/bottom-bar-20-spine-6.3x2.1.webp',
      '/photos/products/bottom-bar-29-spine-6.3x2.9.webp',
    ],
    featured: true,
  },
  {
    ...
    images: [
      '/photos/products/top-bar-18-spine-8.1x2.5.webp',
      '/photos/products/top-bar-20-spine-6.3x2.1.webp',
    ],
    featured: false,
  },
  {
    ...
    images: ['/photos/products/semi-top-bar-19-spine.webp'],
    featured: false,
  },
  {
    id: 'top-cap',
    ...
    images: ['/photos/products/top-cap-20-spine.webp'],
    featured: false,
  },
...

  {
    ...
    images: [
      '/photos/products/mudrest-186x70x25.webp',
    ],
    featured: false,
  },
  {
    ...
    images: [
      '/photos/products/separator-safeguard-170x64x7.webp',
    ],
    featured: false,
  },
  {
    ...
    images: [
      '/photos/products/side-packing.webp',
    ],
    featured: true,
  },
  {
    ...
    variants: ['156×56×5mm'],
    images: ['/photos/products/bottom-buffer.webp'],
    featured: false,
  },
...

  {
    ...
    images: [
      '/photos/products/vent-plug-m22.webp',
      '/photos/products/vent-plug-m22-star-type-dummy.webp',
      '/photos/products/vent-plug-m30-long-buffel.webp',
    ],
    featured: true,
  },
  {
    ...
    images: [
      '/photos/products/mist-eliminator-m30-threaded.webp',
      '/photos/products/mist-eliminator-m30-without-thread.webp',
    ],
    featured: false,
  },
  {
    ...
    images: ['/photos/products/star-plug.webp'],
    featured: false,
  },
  {
    id: 'filling-plug',
    ...
    variants: ['M18'],
    images: ['/photos/products/filling-plug-m18.webp'],
    featured: false,
  },
  {
    id: 'm30-long-buffel-bobbin',
    slug: 'm30-long-buffel-bobbin',
    name: 'Vent Plug M30 Long Buffel Bobbin',
    description: 'Long Buffel bobbin vent plug for M30 battery cell openings. Seals the vent while allowing controlled gas escape during charging, with a close-tolerance bobbin insert for consistent assembly fitment.',
    category: 'battery-components',
    specifications: { 'Material': 'Acid-resistant PP', 'Thread Size': 'M30', 'Application': 'Battery cell venting' },
    variants: ['Standard'],
    images: ['/photos/products/vent-plug-m30-long-buffel-bobbin.webp'],
    featured: false,
  },
...

  {
    ...
    images: [
      '/photos/products/terminal-protector-er-type.webp',
      '/photos/products/terminal-protector-e-rickshaw.webp',
    ],
    featured: false,
  },
  {
    ...
    variants: ['Standard'],
    images: ['/photos/products/terminal-cap.webp'],
    featured: false,
  },
...

  {
    ...
    images: [
      '/photos/products/battery-handle-n50-70.webp',
      '/photos/products/battery-handle-ns40.webp',
    ],
    featured: false,
  },
...

  {
    ...
    variants: ['Standard'],
    images: ['/photos/products/rubber-nozzle.webp'],
    featured: false,
  },
];
